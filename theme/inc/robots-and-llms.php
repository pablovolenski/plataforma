<?php
/**
 * GEO surfaces for LLM crawlers:
 *   1. robots.txt — explicit Allow rules for AI crawlers + sitemap link.
 *   2. /llms.txt — Markdown index of site content (see https://llmstxt.org/).
 */
...
// ---------------------------------------------------------------------------
// /llms.txt — Markdown index for LLM retrieval.
// ---------------------------------------------------------------------------
...
// Flush rewrite rules once so /llms.txt starts routing without a manual
// visit to Settings → Permalinks.
add_action( 'admin_init', function () {
	if ( '1' !== get_option( 'plataforma_llms_rules_v' ) ) {
